...
''';
  ...
  Future<void> uploadAll({
    ...
    // trampoline with no helpers on the board is a cable swap the owner
    // watches in the dark.
    await _ssh.installSignalHelpers();
    await _ssh.installDeviceHelpers();
