...
void main() {
  group('trampoline.sh.template', () {
    ...
    test('the give-up path restores service rather than protecting the install',
      ...
      // The failure signal, which is a red LED and the hazards. A vehicle that
      // abandoned a run silently is one nobody knows to come back to.
      expect(tail, contains('signal_error'));
    });
